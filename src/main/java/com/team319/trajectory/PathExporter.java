...
public class PathExporter {
	...
	public PathExporter(String directory) {
		this.directory = directory;
	}

	public String directory;
	
	public boolean exportPathJavaFile(Path path, SrxTranslatorConfig config,
		...
		// package and imports
		sb.append("package frc.paths;\r\n" + "\r\n"
				+ "import com.team254.lib.trajectory.Path;\r\n");

		// beginning of the class
		sb.append("public class " + config.name + "Path extends Path {");
		...
		sb.append("	Path centerPoints = {\r\n");

		sb.append(serializeTrajectoryPoints(path.getTrajectory()));
		sb.append("		};\r\n" + "\n}");
	...
	private String serializeTrajectoryPoints(Trajectory trajectory) {
		StringBuilder sb = new StringBuilder();
